...
| P0-5 | **Neon SECONDARY password** (`neondb_owner` @ `ep-crimson-tree-atp6kiq0-pooler`, `npg_MyvHzL81UPTa…`) | scripts 6bd47d5 (08-01), bc96d89 (08-02) | **LIVE** (query succeeded as neondb_owner) | Agent can rotate (same ALTER ROLE + Vercel `NEON_2_DATABASE_URL` procedure as P0-6) — pending approval |
...
- 08-13: Neon primary rotated. 08-14: live-validity audit above.

## Recommended close-out order

1. (Agent, on approval) Rotate Neon secondary (P0-5).
