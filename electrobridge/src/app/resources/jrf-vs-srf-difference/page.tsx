...
export const metadata: Metadata = {
  title: "JRF vs SRF vs Research Associate: What's the Difference? | SiliconPath",
  ...
  alternates: { canonical: "https://siliconpath.vercel.app/resources/jrf-vs-srf-difference" },
};
