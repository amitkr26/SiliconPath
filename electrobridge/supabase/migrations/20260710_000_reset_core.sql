...
CREATE POLICY "public read verified opportunities" ON opportunities FOR SELECT USING (is_active = true AND verification_status = 'verified');
...
CREATE POLICY "public read assessments" ON academy_assessments FOR SELECT USING (true);
