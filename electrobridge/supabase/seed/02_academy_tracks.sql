...
VALUES
  ...
  ('verilog',         'Verilog HDL',                           'Behavioral & structural modeling, testbenches, synthesis-aware coding, FPGA implementation.',           'Code2',    '#06b6d4', 2, 21, 42, '{digital-logic}'),
  ('systemverilog',   'SystemVerilog for Verification',        'OOP concepts, constrained random, functional coverage, assertions, interface-based design.',            'Shield',   '#a855f7', 3, 21, 45, '{verilog}'),
  ...
  ('rtl-design',      'RTL Design & Synthesis',                'Microarchitecture, pipeline design, clock domain crossing, synthesis constraints, optimization.',       'Layers',   '#10b981', 5, 21, 40, '{verilog}'),
  ('physical-design', 'Physical Design & Backend',             'Floorplanning, placement, CTS, routing, STA, IR drop, DRC/LVS, signoff methodology.',                    'Layers',   '#ef4444', 6, 28, 50, '{rtl-design}'),
