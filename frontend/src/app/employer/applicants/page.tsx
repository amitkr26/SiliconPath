      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-6">
        ...
        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
          ...
          <Link
            ...
            className="px-4 py-2.5 rounded-xl bg-white border border-slate-200 text-slate-900 text-xs font-bold shadow-xs hover:shadow-card hover:bg-slate-50 hover:border-slate-300 transition-all flex items-center gap-2 shrink-0 self-start sm:self-center"
          >
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-3 bg-white p-3 border border-slate-200 rounded-2xl shadow-card">
          {/* JOB FILTER */}
          <div className="sm:col-span-1">
            ...
            <select
              ...
              className="w-full px-3 py-2 bg-slate-50 border border-slate-200 rounded-lg text-xs font-semibold text-slate-900 focus:outline-none focus:border-blue-600 focus:ring-1 focus:ring-blue-600 transition-all"
            >
          ...
          <div className="sm:col-span-2">
            ...
            <div className="relative">
              ...
              <input
                ...
                className="w-full pl-9 pr-3 py-2 text-xs font-medium bg-slate-50 border border-slate-200 rounded-lg text-slate-900 placeholder:text-slate-400 focus:outline-none focus:border-blue-600 focus:ring-1 focus:ring-blue-600 transition-all"
              />
            </div>
          </div>
        </div>
        ...
        {filteredApplications.length === 0 ? (
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
              ...
              {filteredApplications.map((app) => {
                ...
                return (
                  <div
                    ...
                    className={`p-5 bg-white border rounded-2xl transition-all cursor-pointer space-y-3 ${
                      isSelected
                        ? "border-blue-600 shadow-elevated ring-2 ring-blue-600/20"
                        : "border-slate-200 shadow-card hover:shadow-elevated hover:border-slate-300"
                    }`}
                  >
                    <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3">
                      ...
                      <div className="flex items-center gap-2 self-end sm:self-center" onClick={(e) => e.stopPropagation()}>
                        <select
                          ...
                          className="px-3 py-1.5 bg-slate-50 border border-slate-200 rounded-xl text-xs font-semibold text-slate-900 shadow-xs focus:outline-none focus:border-blue-600 focus:ring-1 focus:ring-blue-600 transition-all"
                        >
            ...
            <div className="lg:col-span-1">
              {selectedApp ? (
                <div className="p-6 bg-white border border-slate-200 rounded-2xl shadow-card space-y-5 sticky top-24">
                  ...
                  <div className="space-y-2 pt-2 border-t border-slate-100">
                    {selectedApp.user_profile?.username && (
                      <Link
                        ...
                        className="w-full py-2.5 rounded-xl bg-slate-50 hover:bg-slate-100 border border-slate-200 text-slate-900 text-xs font-bold shadow-xs hover:shadow-card transition-all flex items-center justify-center gap-2"
                      >
                    ...
                    <Link
                      href={`/messages`}
                      className="w-full py-2.5 rounded-xl bg-blue-600 hover:bg-blue-700 border border-blue-600 text-white text-xs font-bold shadow-xs hover:shadow-card transition-all flex items-center justify-center gap-2"
                    >
