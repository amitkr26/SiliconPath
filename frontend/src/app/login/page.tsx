    ...
    <div className="min-h-screen bg-bg-primary text-slate-900 py-12 px-4 flex items-center justify-center">
      <div className="max-w-md w-full space-y-6">
        ...
        <div className="text-center space-y-2">
          ...
          <p className="text-slate-500 text-xs sm:text-sm font-medium">Sign in to your candidate or employer account</p>
        </div>

        {/* LOGIN CARD */}
        <Card className="p-8 space-y-5 border border-slate-200 shadow-card">
          ...
          <div className="relative flex justify-center text-xs">
            <span className="bg-white px-3 font-medium text-slate-400 z-10 uppercase tracking-wider">or continue with email or username</span>
