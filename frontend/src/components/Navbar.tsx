...
import {
  Briefcase, Info, Mail, Search, Menu, X, User, LogOut, CircuitBoard, LogIn, UserPlus
} from "lucide-react";
import { useUser } from "@/hooks/useUser";

const PUBLIC_NAV_ITEMS = [
  { href: "/about", label: "About", icon: Info },
  { href: "/opportunities", label: "Services", icon: Briefcase },
  ...
  return (
    <header className="sticky top-0 z-50 bg-white border-b-4 border-slate-900 shadow-[0_4px_0px_0px_rgba(15,23,42,0.1)]">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-16 flex items-center justify-between gap-4">
        ...
        {/* SEARCH BAR (⌘K) */}
        <form onSubmit={doSearch} className="hidden md:flex flex-1 max-w-sm relative">
        ...
        {/* HEADER NAV LINKS: About, Services, Contact */}
              ...
              <Link
                ...
                className={`flex items-center gap-1.5 px-3.5 py-1.5 rounded-xl text-xs font-black transition-all border-2 border-slate-900 ${
                  active
                    ...
                    : "bg-white text-slate-900 hover:bg-blue-50 hover:text-blue-600 hover:shadow-[2.5px_2.5px_0px_0px_#0F172A] hover:-translate-y-0.5"
                }`}
              >
