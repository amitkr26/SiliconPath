 ...
 * ponytail: Lucide doesn't ship Pinterest/Reddit/X-brand icons.
 * These are the official simplified marks — clean, monochrome, 16x16.
 */
...
/** Map platform key to icon component */
const ICON_MAP: Record<string, React.ComponentType<{ className?: string }>> = {
  linkedin: LinkedInIcon,
  github: GitHubIcon,
  instagram: InstagramIcon,
  "instagram-academy": InstagramIcon,
  youtube: YouTubeIcon,
  x: XIcon,
