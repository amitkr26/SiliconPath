...
function addSecurityHeaders(response: NextResponse): void {
  const csp = [
    ...
    "img-src 'self' data: blob: https://*.supabase.co https://*.vercel.app https://img.youtube.com https://avatars.githubusercontent.com https://lh3.googleusercontent.com https://media.licdn.com https://*.gov.in https://*.res.in https://*.ac.in https://*.unsplash.com https://images.unsplash.com",
    "font-src 'self'",
