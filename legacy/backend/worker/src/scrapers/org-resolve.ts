/**
 * Evidence-gated organization resolution (P0.3), ported 1:1 from the
 * production frontend `frontend/src/lib/organizations/resolve.ts`.
 *
 ...
 * Pure module (zero imports) so the replica worker can run it directly.
 */
...
// Display fallback for known domains not (yet) in the org table.
