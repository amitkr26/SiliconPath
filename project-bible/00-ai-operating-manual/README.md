...
This manual defines how AI coding agents should operate within the SiliconPath repository. It establishes the contract between human developers and AI agents, ensuring consistent, safe, and effective contributions.
