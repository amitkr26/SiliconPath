...
This contract defines the explicit terms under which AI agents may modify the SiliconPath codebase. It establishes boundaries, permissions, and obligations.
