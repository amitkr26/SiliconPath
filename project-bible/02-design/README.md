...
The SiliconPath design system is a dark-first theme with cyan/teal accent colors, built on Tailwind CSS. The system uses OKLCH color space for perceptual uniformity and fluid typography for responsive scaling.
