...
SiliconPath provides 74 API routes organized into public, protected, admin, and cron categories. All routes live in the Next.js app at `electrobridge/src/app/api/`.
