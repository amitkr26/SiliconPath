...
SiliconPath implements a centralized AI Gateway through which all AI requests must pass. No module is allowed to call an AI provider directly. The gateway provides automatic fallback, health monitoring, retry, and usage analytics.
