...
This directory contains the master prompt library for AI agent interactions within the SiliconPath project. These prompts are optimized for specific tasks and follow the patterns defined in the AI Operating Manual.

## Prompt Categories

### Development Prompts
Prompts for AI coding agents working on the SiliconPath codebase:
