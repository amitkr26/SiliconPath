...
Governance rules for the SiliconPath project-bible documentation and repository. These rules define how documentation is maintained, reviewed, versioned, and deprecated. They apply to all AI agents and human contributors working on this project.
