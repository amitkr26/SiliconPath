...
This directory contains Architecture Decision Records (ADRs) documenting significant architectural decisions made during SiliconPath development. Each ADR follows the MADR (Markdown Architectural Decision Records) template.
