...
SiliconPath is a bootstrapped project with no revenue. All infrastructure decisions must consider cost. Previously, there was no explicit policy on service tier selection, leading to potential accidental over-provisioning.
