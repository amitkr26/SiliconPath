...
| `backend/server` Express API on :8080 | IMPLEMENTED (DEPLOYED 2026-08-20, Render `free` plan; cron pending billing #14) | 46 node:test (30 parity + 16 hardening); full route surface incl. social/AI/auth/search/news-cron; 502 `AI_UNAVAILABLE`, `/health/ready`, admin rate-limit, timing-safe admin+cron guards; graceful SIGTERM shutdown (verified in Docker); live: /health + /health/ready 200, auth 200/401, AI summarize 200 (groq/qwen3.6-27b), cron news-sync inserted 58 + worker prod runs +5 / 0 duplicates (285 stable) |
