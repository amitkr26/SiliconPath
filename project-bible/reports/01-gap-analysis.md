...
|---------------------|--------|-----|
| `monorepo root` | `electrobridge/` + `backend/` + `neon/` | ✓ Match |
| `project-bible/` | ✓ Exists | ✓ Match |
| `electrobridge/src/app/api/` | 37 route groups | Covers 60 of 74 routes |
| `electrobridge/src/config/` | `config/scrapers/` | Only scraper configs, no general config directory |
| `electrobridge/src/__tests__/` | 4 test files | Severely under-tested |
...
| `electrobridge/src/lib/academy/types.ts` | ✓ Exists | ✓ Match |
| `electrobridge/src/lib/academy/queries.ts` | ✓ Exists | ✓ Match |
...
| `ci-siliconpath.yml` | ✅ Exists | ✓ Match |
