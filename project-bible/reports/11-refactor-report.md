...
### Files Modified: 52
All existing API routes updated to use `@siliconpath/api` shared package
...
```typescript
import { success, list, validationError, serverError, withAdmin } from "@siliconpath/api";
import { adminOpportunityUpdateSchema } from "@siliconpath/api";
import { supabaseAdmin, isAdminConfigured } from "@/lib/supabase";
```
